...
public class RegisterWindow extends JFrame {  
	...
	public RegisterWindow(Authentication auth, User u, MatchSystem ms){ 
		this.auth_obj = auth;
		this.user_obj = u;
		...
		JLabel label_title = new JLabel("Register Page");
	...
	public void openMainWindow(){
		auth_obj.register(input_user.getText(),input_pass.getText());
